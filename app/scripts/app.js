...
.config(['$authProvider',
	function($authProvider) {
		...
		//$authProvider.loginUrl = 'http://50.16.161.152/efinding/oauth/token'; //Desarrollo
		$authProvider.loginUrl = 'http://50.16.161.152/efinding-staging/oauth/token'; //Producción
